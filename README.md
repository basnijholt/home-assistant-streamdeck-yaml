...
|:------------------------|:-----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------|:------------------------------------------------------------------------------------------------------------------------------|
| `service`               | ✅                | The Home Assistant service to call when the action is triggered.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |           | `Optional[str]`                                                                                                               |
...
| `text_offset`           | ❌                | The icon filename to display on the button. Make the path absolute (e.g., `/config/streamdeck/my_icon.png`) or relative to the `assets` directory (e.g., `my_icon.png`). If empty, a icon with `icon_background_color` and `text` is displayed. The icon can be a URL to an image, like `'url:https://www.nijho.lt/authors/admin/avatar.jpg'`, or a `spotify:` icon, like `'spotify:album/6gnYcXVaffdG0vwVM34cr8'`. If the icon is a `spotify:` icon, the icon will be downloaded and cached. The icon can also display a partially complete ring, like a progress bar, or sensor value, like `ring:25` for a 25% complete ring.                                                                                                                                        | `0`       | `int`                                                                                                                         |
| `icon`                  | ✅                | Icon filename to display. Use absolute paths (e.g., /config/streamdeck/my_icon.png) or relative to the assets directory (e.g., my_icon.png). If empty, displays an icon with icon_background_color and text. Supports URLs (e.g., url:https://example.com/image.jpg), Spotify icons (e.g., spotify:album/6gnYcXVaffdG0vwVM34cr8), or rings (e.g., ring:25 for a 25% complete ring).                                                                                                                                                                                                                                                                                                                                                                                     |           | `Optional[str]`                                                                                                               |
...
| `icon_gray_when_off`    | ❌                | If icon and entity_id are specified, convert the icon to grayscale when the state is off.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `False`   | `bool`                                                                                                                        |
...
| `linked_entity`            | ✅                | A secondary entity_id that is used for updating images and states.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |           | `Optional[str]`            |
| `text`                     | ✅                | The text to display above the dial or dial. If empty, no text is displayed. You might want to add `\n` characters to spread the text over several lines, or use the `\|` character in YAML to create a multi-line string.                                                                                                                                                                                                                                                                                                                                                                                                         |           | `Optional[str]`            |
| `text_color`               | ✅                | Color of the text. If empty, the color is `white`, unless an `entity_id` is specified, in which case the color is `amber` when the state is `on`, and `white` when it is `off`.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |           | `Optional[str]`            |
| `text_size`                | ❌                | Integer size of the text.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `12`      | `int`                      |
| `text_offset`              | ❌                | The icon filename to display above the dial. Make the path absolute (e.g., `/config/streamdeck/my_icon.png`) or relative to the `assets` directory (e.g., `my_icon.png`). If empty, a icon with `icon_background_color` and `text` is displayed. The icon can be a URL to an image, like `'url:https://www.nijho.lt/authors/admin/avatar.jpg'`, or a `spotify:` icon, like `'spotify:album/6gnYcXVaffdG0vwVM34cr8'`. If the icon is a `spotify:` icon, the icon will be downloaded and cached. The icon can also display a partially complete ring, like a progress bar, or sensor value, like `ring:25` for a 25% complete ring. | `0`       | `int`                      |
| `icon`                     | ✅                | Icon filename to display. Use absolute paths (e.g., /config/streamdeck/my_icon.png) or relative to the assets directory (e.g., my_icon.png). If empty, displays an icon with icon_background_color and text. Supports URLs (e.g., url:https://example.com/image.jpg), Spotify icons (e.g., spotify:album/6gnYcXVaffdG0vwVM34cr8), or rings (e.g., ring:25 for a 25% complete ring).                                                                                                                                                                                                                                               |           | `Optional[str]`            |
...
| `icon_mdi_color`           | ✅                | The color of the Material Design Icon (in hex format, e.g., '#FF0000'). If empty, the color is derived from `text_color` but is less saturated (gray is mixed in).                                                                                                                                                                                                                                                                                                                                                                                                                                                                |           | `Optional[str]`            |
| `icon_gray_when_off`       | ❌                | If icon and entity_id are specified, convert the icon to grayscale when the state is off.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `False`   | `bool`                     |
| `turn`                     | ✅                | Configuration for the dial's turn behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |           | `Optional[DialTurnConfig]` |
| `push`                     | ✅                | Configuration for the dial's push behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |           | `Optional[DialPushConfig]` |
| `allow_touchscreen_events` | ✅                | Whether events from the touchscreen are allowed, for example set the minimal value on `SHORT` and set maximal value on `LONG`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `False`   | `bool`                     |
