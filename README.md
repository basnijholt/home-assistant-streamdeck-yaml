...
| `anonymous_pages`    | A list of anonymous `Page`s in the configuration. These are pages that are not shown when skipping through pages. These pages are for single use only, meaning you click on a button and it goes back to last page. |           | `List[Page]`    |
| `current_page_index` | The index of the current page.                                                                                                                                                                                      | `0`       | `int`           |
| `state_entity_id`    | The entity ID to sync display state with.                                                                                                                                                                           | `None`    | `Optional[str]` |
| `is_on`              | The on/off state of the Stream Deck.                                                                                                                                                                                | `True`    | `bool`          |
...
| Variable name   | Description                    | Default    | Type           |
|:----------------|:-------------------------------|:-----------|:---------------|
| `name`          | The name of the page.          | `Ellipsis` | `str`          |
