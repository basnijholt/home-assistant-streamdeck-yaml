...
| `anonymous_pages`    | A list of anonymous `Page`s in the configuration. These are pages that are not shown when skipping through pages. These pages are for single use only, meaning you click on a button on this page, it goes back to last page. |           | `List[Page]`    |
