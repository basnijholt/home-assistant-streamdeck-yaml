...
| `delay`                 | ❌                | The delay (in seconds) before the `service` is called. This is useful if you want to wait for the state to change before calling the `service`. Counts down from the time the button is pressed. If while counting the button is pressed again, the timer is cancelled.                                                                                                                                                                                                                                                                                                                |           | `float`                                                                                               |
